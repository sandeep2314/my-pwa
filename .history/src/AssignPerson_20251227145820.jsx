...
const BASE_URL = import.meta.env.VITE_API_URL; // <-- important
...
const customStyles = {
  control: (provided) => ({ ...provided, backgroundColor: "#262626", color: "#fff", borderRadius: "6px", borderColor: "#555" }),
  menu: (provided) => ({ ...provided, backgroundColor: "#262626", color: "#fff" }),
  option: (provided, state) => ({
    ...provided,
    backgroundColor: state.isSelected ? "#0d6efd" : state.isFocused ? "#333" : "#262626",
    color: "#fff",
    cursor: "pointer",
  }),
